...
public class TC109 extends BaseTest{
		...
		@Test(dataProvider = "getData109")
		public void TC109(HashMap<String, String> hMap) {
			...
			bcp.verifyTitle(hMap.get("ExpectedTitle"));
		}

		@DataProvider
		public Object[][] getData109() {

			Object[][] obj = new Object[1][1];
			obj[0][0] = UtilKit3.getTestDataFromExcel("TC-109");
			return obj;
