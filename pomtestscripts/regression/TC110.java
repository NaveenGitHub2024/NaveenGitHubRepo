...
public class TC110 extends BaseTest{
	
	@Test(dataProvider = "getData110")
	public void TC110(HashMap<String, String> hMap) {
...
//		String TotalPrice=String.valueOf(hMap.get("TotalPrice"));
...
//			}
		...
		bhp.verifyValue(bhp.TotalPrice(), hMap.get("TotalPrice"));				
	}

	@DataProvider
	public Object[][] getData110() {

		Object[][] obj = new Object[1][1];
		obj[0][0] = UtilKit3.getTestDataFromExcel("TC-110");
		return obj;
